...
public interface Database {
     ...
     */
    void addUserInfo(PlayerUser user) throws UserAlreadyExistsException;
     ...
     */
    void deleteUserInfo(PlayerUser user) throws UsernameDoesNotExist;
     ...
     */
    void updateUserPassword(PlayerUser user) throws UsernameDoesNotExist;
     ...
     */
    boolean checkUserPassword(PlayerUser user);
     ...
     */
    PlayerUser getPlayerUserByName(String username) throws UsernameDoesNotExist;
